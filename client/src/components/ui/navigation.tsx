...
const navItems = [
  ...
  { label: "Services", href: "#services", protected: true },
  { label: "Pricing", href: "#pricing", protected: true },
  { label: "Portfolio", href: "#portfolio", protected: true },
  { label: "Testimonials", href: "#testimonials", protected: true },
  { label: "FAQ", href: "#faq", protected: true }
];

// Discord Login Button component - placeholder implementation
